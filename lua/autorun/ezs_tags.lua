...
--Keaton's custom hooks

hook.Add( "PlayerSpawn", "donationname", function(ply) ply:SetNWString("customtitle", ply:GetPData("customtitle", " "))
end)

hook.Add( "PlayerSpawn", "donationcolor", function(ply) ply:SetNWString("customtitlecolor", ply:GetPData("customtitlecolor", "157 19 229 255"))
end)
